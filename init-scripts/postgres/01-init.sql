...
CREATE SCHEMA IF NOT EXISTS aneel;
...
GRANT USAGE ON SCHEMA aneel TO flyway_user;
GRANT CREATE ON SCHEMA aneel TO flyway_user;
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA aneel TO flyway_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA aneel TO flyway_user;
...
ALTER SCHEMA aneel OWNER TO flyway_user;
